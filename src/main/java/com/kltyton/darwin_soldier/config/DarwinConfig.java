...
public final class DarwinConfig {
    ...
    public static final ModConfigSpec.DoubleValue PEACEFUL_GROWTH;
    public static final ModConfigSpec.DoubleValue NEUTRAL_GROWTH;
    public static final ModConfigSpec.DoubleValue HOSTILE_GROWTH;
    public static final ModConfigSpec.DoubleValue BOSS_GROWTH;
    public static final ModConfigSpec.DoubleValue BOSS_HEALTH_THRESHOLD;
    public static final ModConfigSpec.DoubleValue POINTS_PER_ATTRIBUTE_POINT;
    public static final ModConfigSpec.DoubleValue LOW_HEALTH_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue ANTI_AFK_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue PET_GROWTH_MULTIPLIER;
    public static final ModConfigSpec.IntValue PARTICIPATION_REFRESH_INTERVAL_SECONDS;
    public static final ModConfigSpec.IntValue PARTICIPATION_EXPIRE_SECONDS;
    public static final ModConfigSpec.IntValue PARTICIPATION_MAX_PLAYERS;
    public static final ModConfigSpec.DoubleValue HEALTH_PER_POINT;
    public static final ModConfigSpec.DoubleValue ATTACK_PER_POINT;
    public static final ModConfigSpec.DoubleValue DEFENSE_PER_POINT;
    public static final ModConfigSpec.DoubleValue BASE_CRITICAL_CHANCE;
    public static final ModConfigSpec.DoubleValue BASE_CRITICAL_DAMAGE;
    public static final ModConfigSpec.DoubleValue PERCEPTION_CRITICAL_CHANCE_PER_POINT;
    public static final ModConfigSpec.DoubleValue PERCEPTION_CRITICAL_DAMAGE_PER_POINT;
    public static final ModConfigSpec.BooleanValue DERIVED_ATTRIBUTES_ENABLED;
    public static final ModConfigSpec.IntValue HEALING_AMPLIFICATION_HEALTH_POINTS;
    public static final ModConfigSpec.DoubleValue HEALING_AMPLIFICATION_PER_STEP;
    public static final ModConfigSpec.IntValue ARMOR_PIERCE_ATTACK_POINTS;
    public static final ModConfigSpec.DoubleValue ARMOR_PIERCE_PER_STEP;
    public static final ModConfigSpec.IntValue ARMOR_TOUGHNESS_DEFENSE_POINTS;
    public static final ModConfigSpec.DoubleValue ARMOR_TOUGHNESS_PER_STEP;
    public static final ModConfigSpec.BooleanValue MINIMUM_EFFECTIVE_DAMAGE_ENABLED;
    public static final ModConfigSpec.DoubleValue MINIMUM_EFFECTIVE_DAMAGE_RATIO;
    public static final ModConfigSpec.IntValue MINIMUM_EFFECTIVE_DAMAGE_WINDOW_TICKS;
    public static final ModConfigSpec.IntValue PERCEPTION_MAX_POINTS;
    public static final ModConfigSpec.IntValue SUPER_PERCEPTION_UNLOCK_POINTS;
    public static final ModConfigSpec.DoubleValue SUPER_PERCEPTION_DISTANCE;
    public static final ModConfigSpec.DoubleValue SUPER_PERCEPTION_ANGLE;
    public static final ModConfigSpec.BooleanValue SUPER_PERCEPTION_TARGET_MONSTERS;
    public static final ModConfigSpec.BooleanValue SUPER_PERCEPTION_TARGET_NEUTRAL;
    public static final ModConfigSpec.BooleanValue SUPER_PERCEPTION_TARGET_PASSIVE;
    public static final ModConfigSpec.BooleanValue SUPER_PERCEPTION_TARGET_PLAYERS;
    public static final ModConfigSpec.BooleanValue SUPER_PERCEPTION_FILTER_PETS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SUPER_PERCEPTION_WHITELIST;
    public static final ModConfigSpec.BooleanValue NUTRITION_ENABLED;
    public static final ModConfigSpec.IntValue NUTRITION_MAX_POINTS;
    public static final ModConfigSpec.IntValue NUTRITION_BASE_MAX_FOOD;
    public static final ModConfigSpec.IntValue NUTRITION_MAX_FOOD_PER_POINT;
    public static final ModConfigSpec.DoubleValue NUTRITION_FOOD_RESTORE_BONUS_PER_POINT;
    public static final ModConfigSpec.DoubleValue NUTRITION_SATURATION_RESTORE_BONUS_PER_POINT;
    public static final ModConfigSpec.DoubleValue NUTRITION_DRINK_RESTORE_BONUS_PER_POINT;
    public static final ModConfigSpec.IntValue EFFICIENT_METABOLISM_UNLOCK_POINTS;
    public static final ModConfigSpec.IntValue EFFICIENT_METABOLISM_INTERVAL_TICKS;
    public static final ModConfigSpec.DoubleValue EFFICIENT_METABOLISM_HEAL_MAX_HEALTH_PERCENT;
    public static final ModConfigSpec.IntValue EFFICIENT_METABOLISM_FOOD_COST;
    public static final ModConfigSpec.IntValue EFFICIENT_METABOLISM_MIN_FOOD;
    public static final ModConfigSpec.DoubleValue EFFICIENT_METABOLISM_THIRST_COST;
    public static final ModConfigSpec.DoubleValue EFFICIENT_METABOLISM_MIN_THIRST_PERCENT;
    public static final ModConfigSpec.IntValue NUTRITION_FULLNESS_UNLOCK_POINTS;
    public static final ModConfigSpec.DoubleValue NUTRITION_FULLNESS_THRESHOLD;
    public static final ModConfigSpec.IntValue NUTRITION_FULLNESS_HASTE_LEVEL;
    public static final ModConfigSpec.DoubleValue NUTRITION_FULLNESS_ABSORPTION_BASE;
    public static final ModConfigSpec.DoubleValue NUTRITION_FULLNESS_ABSORPTION_MAX_HEALTH_PERCENT;
    public static final ModConfigSpec.IntValue NUTRITION_FULLNESS_ABSORPTION_REFILL_SECONDS;
    public static final ModConfigSpec.IntValue NUTRITION_FULLNESS_COMBAT_DELAY_SECONDS;
    public static final ModConfigSpec.BooleanValue ADAPTATION_ENABLED;
    public static final ModConfigSpec.BooleanValue ADAPTATION_PVP_ENABLED;
    public static final ModConfigSpec.IntValue DAMAGE_ADAPTATION_UNLOCK_POINTS;
    public static final ModConfigSpec.IntValue HUNTING_INSTINCT_UNLOCK_POINTS;
    public static final ModConfigSpec.IntValue STRESS_EVOLUTION_UNLOCK_POINTS;
    public static final ModConfigSpec.DoubleValue ADAPTATION_LV1;
    public static final ModConfigSpec.DoubleValue ADAPTATION_LV2;
    public static final ModConfigSpec.DoubleValue ADAPTATION_LV3;
    public static final ModConfigSpec.DoubleValue ADAPTATION_LV4;
    public static final ModConfigSpec.DoubleValue ADAPTATION_LV5;
    public static final ModConfigSpec.IntValue ADAPTATION_MAX_LEVEL;
    public static final ModConfigSpec.BooleanValue HUNT_ENABLED;
    public static final ModConfigSpec.DoubleValue HUNTING_DAMAGE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue HUNTING_BASE_KNOCKBACK;
    public static final ModConfigSpec.DoubleValue HUNTING_KNOCKBACK_PER_DAMAGE;
    public static final ModConfigSpec.DoubleValue HUNTING_MAX_KNOCKBACK;
    public static final ModConfigSpec.IntValue HUNTING_ACTIVATION_PARTICLE_COUNT;
    public static final ModConfigSpec.IntValue HUNTING_HIT_PARTICLE_COUNT;
    public static final ModConfigSpec.IntValue HUNTING_ACTIVE_SECONDS;
    public static final ModConfigSpec.IntValue HUNTING_SPEED_LEVEL;
    public static final ModConfigSpec.IntValue HUNTING_JUMP_LEVEL;
    public static final ModConfigSpec.IntValue HUNTING_COOLDOWN_SECONDS;
    public static final ModConfigSpec.IntValue HUNTING_LOW_HEALTH_COOLDOWN_SECONDS;
    public static final ModConfigSpec.DoubleValue HUNTING_LOW_HEALTH_PERCENT;
    public static final ModConfigSpec.BooleanValue HUNTING_INTERNAL_IMPACT_ENABLED;
    public static final ModConfigSpec.DoubleValue HUNTING_SHOCK_RADIUS;
    public static final ModConfigSpec.DoubleValue HUNTING_SHOCK_DAMAGE_MULTIPLIER;
    public static final ModConfigSpec.IntValue HUNTING_INJURY_DURATION_SECONDS;
    public static final ModConfigSpec.IntValue HUNTING_INJURY_INTERVAL_TICKS;
    public static final ModConfigSpec.DoubleValue HUNTING_INJURY_DAMAGE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue HUNTING_VULNERABILITY_BONUS;
    public static final ModConfigSpec.BooleanValue BATTLE_INSTINCT_ENABLED;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_UNLOCK_POINTS;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_MAX_RESERVES;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_RECOVER_SECONDS;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_LOW_HEALTH_RECOVER_SECONDS;
    public static final ModConfigSpec.DoubleValue BATTLE_INSTINCT_LOW_HEALTH_PERCENT;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_INVULNERABILITY_TICKS;
    public static final ModConfigSpec.DoubleValue BATTLE_INSTINCT_COUNTER_DAMAGE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue BATTLE_INSTINCT_COUNTER_RANGE_PADDING;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_COUNTER_KILL_RESERVES;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_BLOCK_POSE_TICKS;
    public static final ModConfigSpec.IntValue BATTLE_INSTINCT_TRAIL_TICKS;
    public static final ModConfigSpec.DoubleValue BATTLE_INSTINCT_BLOCK_SOUND_VOLUME;
    public static final ModConfigSpec.DoubleValue BATTLE_INSTINCT_BLOCK_SOUND_PITCH;
    public static final ModConfigSpec.BooleanValue EVOLUTION_ENABLED;
    public static final ModConfigSpec.IntValue STRESS_UTILITY_EFFECT_SECONDS;
    public static final ModConfigSpec.IntValue STRESS_RESISTANCE_SECONDS;
    public static final ModConfigSpec.DoubleValue STRESS_SHOCK_RANGE;
    public static final ModConfigSpec.DoubleValue STRESS_NORMAL_KNOCKBACK;
    public static final ModConfigSpec.DoubleValue STRESS_ENHANCED_KNOCKBACK;
    public static final ModConfigSpec.IntValue STRESS_NORMAL_SLOW_LEVEL;
    public static final ModConfigSpec.IntValue STRESS_NORMAL_SLOW_SECONDS;
    public static final ModConfigSpec.IntValue STRESS_ENHANCED_SLOW_LEVEL;
    public static final ModConfigSpec.IntValue STRESS_ENHANCED_SLOW_SECONDS;
    public static final ModConfigSpec.IntValue STRESS_COOLDOWN_SECONDS;
    public static final ModConfigSpec.IntValue STRESS_DAMAGE_COOLDOWN_REDUCTION_SECONDS;
    public static final ModConfigSpec.IntValue STRESS_DAMAGE_COOLDOWN_REDUCTION_INTERVAL_SECONDS;
    public static final ModConfigSpec.IntValue STRESS_VISUAL_EXPLOSION_PARTICLES;
    public static final ModConfigSpec.IntValue STRESS_VISUAL_SHOCKWAVE_PARTICLES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> INTIMIDATION_IMMUNITY;
    public static final ModConfigSpec.BooleanValue RUNTIME_DIAGNOSTICS_ENABLED;
    ...
    private static void replaceLegacyDefault(ModConfigSpec.DoubleValue value, double legacy, double replacement) {
